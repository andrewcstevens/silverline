...
| 5 | PRE-0 Price-Aware Signal Guardrails — Technical Discovery & Test Plan | Complete | `feature/pre-0-guardrails` (`39f3296`) | — | Reference impl + 13/13 tests + discovery; Founder decisions #11–#14 | Autonomous-safe (done) |
